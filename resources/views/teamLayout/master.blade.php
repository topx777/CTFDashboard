...
<head>
    ...
    <title>{{ config('app.name', 'Laravel') }} - @yield('title', 'Panel de Equipo')</title>
...
<body class="theme-cyan font-montserrat box_layout h-menu">
        ...
        <div class="card setting_switch">
            ...
            <ul class="list-group">
                ...
                <li class="list-group-item">
                    ...
                    <div class="float-right">
                        <label class="switch">
                            <input type="checkbox" class="hmenu-btn" checked="">
                            <span class="slider round"></span>
                        </label>
                    </div>
                </li>
    ...
    <div id="wrapper">
        ...
        {{-- top navbar --}}
        @include('teamLayout.components.topNavbar')
        ...
        {{-- sidebar --}}
        @include('teamLayout.components.sidebar')
