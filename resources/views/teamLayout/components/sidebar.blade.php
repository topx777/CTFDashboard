                ...
                <div class="sidebar-scroll">
                    ...
                    <nav id="left-sidebar-nav" class="sidebar-nav">
                        <ul id="main-menu" class="metismenu">
                            ...
                            <li>
                                <a href="#myPage" class="has-arrow"><i class="icon-home"></i><span>My
                                        Page</span></a>
                                <ul>
                            ...
                            <li><a href="index2.html"><i class="icon-speedometer"></i><span>Dashboard</span></a>
                            </li>
                            <li><a href="index3.html"><i class="icon-diamond"></i><span>Crypto Coin</span></a>
                            </li>
                            <li><a href="../hrms/index.html"><i class="icon-rocket"></i><span>HRMS
                                        System</span></a></li>
                            <li><a href="../jobportal/index.html"><i class="icon-badge"></i><span>Job
                                        Portal</span></a></li>
                            <li><a href="../landing/index.html"><i class="icon-cursor"></i><span>Landing
                                        Page</span></a></li>
                            <li class="header">App</li>
                            <li>
                                <a href="#Contact" class="has-arrow"><i
                                        class="icon-book-open"></i><span>Contact</span></a>
                                <ul>
                                    <li><a href="app-contact.html">List View</a></li>
                                    <li><a href="app-contact2.html">Grid View</a></li>
                                </ul>
                            </li>
                            <li><a href="app-inbox.html"><i class="icon-envelope"></i><span>Email</span></a>
                            </li>
                            <li><a href="app-chat.html"><i class="icon-bubbles"></i><span>Messenger</span></a>
                            </li>
                            <li>
                                <a href="#Project" class="has-arrow"><i
                                        class="icon-bubbles"></i><span>Project</span></a>
                                <ul>
                            ...
                            <li>
                                <a href="#charts" class="has-arrow"><i
                                        class="icon-pie-chart"></i><span>Charts</span></a>
                                <ul>
                            ...
                            <li><a href="map-jvectormap.html"><i class="icon-map"></i><span>jVector
                                        Map</span></a></li>
                            ...
                            <li><a href="../documentation/index.html"><i
                                        class="icon-doc"></i><span>Documentation</span></a></li>
                        </ul>
                    </nav>
                </div>
            </div>
